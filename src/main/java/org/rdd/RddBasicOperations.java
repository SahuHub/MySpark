...
public class RddBasicOperations {
    ...
    public static void javaRddDemo(JavaSparkContext javaSparkContext) {
        ...
        JavaPairRDD<Integer, String> customerJavaPairRDD = customerWithoutHeader.mapToPair(t -> {
            ...
            Tuple2<Integer, String> tuple = new Tuple2(Integer.parseInt(split[0]), split[1]);
            return tuple;
        });
        ...
        System.out.println("unique values in rdd:");
        JavaPairRDD<String, Integer> stringIntegerJavaPairRDD1 = stringIntegerJavaPairRDD.reduceByKey((a, b) -> a);
        stringIntegerJavaPairRDD1.foreach(t -> System.out.println("contact:" + t._2 + ";name:" + t._1));
